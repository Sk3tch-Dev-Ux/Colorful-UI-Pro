...
//     static void Cleanup()
//     {
//         for (int i = 0; i < s_Handlers.Count(); i++) delete s_Handlers[i];
//         s_Handlers.Clear();
//     }
...
//         if (textWidget) { textWidget.SetText(text); button.SetText(""); }
...
//     // SOLID button (new)
//     static void proSolidBtn(ButtonWidget button, string text, int bgColor, int hoverBgColor,
//                             string clickAction = "", Class targetClass = null, string callbackMethod = "",
//                             string serverIP = "", int serverPort = 0)
//     {
//         if (!button) return;
...
//         CUIButtonHandler handler = new CUIButtonHandler(button, textWidget, imageWidget,
//                                                         bgColor, hoverBgColor, clickAction, targetClass,
//                                                         callbackMethod, serverIP, serverPort);
//         handler.SetSolidBg(true); // flip solid mode
//         s_Handlers.Insert(handler);
//     }
// }
